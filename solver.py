# https://forum.taichi.graphics/t/vortex-method-demo/775
...
ux = ti.field(ti.f32, shape=(Nx, Ny))  # velocity x
uy = ti.field(ti.f32, shape=(Nx, Ny))  # velocity y
omega = ti.field(ti.f32, shape=(Nx, Ny))  # vorticity
omega_temp = ti.field(ti.f32, shape=(Nx, Ny))  # vorticity
sigma = ti.field(ti.f32, shape=(Nx, Ny))  # stream function

color_buffer = ti.Vector.field(3, ti.f32, shape=(Nx, Ny))
